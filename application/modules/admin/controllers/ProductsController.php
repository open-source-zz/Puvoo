...

{
...

    {
		...
		$this->view->category = $product->getCateTree();
...

	{
		...
		if($product_id != '' ){ 
			$this->view->taxrate_class = $product->fetchAllRecords("tax_rate_class","user_id = ".$product->GetUseridByProduct($product_id));
		}
	...
	function resizeimageAction()
	{
			...
			$filename =  SITE_PRODUCT_IMAGES_FOLDER."/p113/46ca81ef9f91ee593c733d57d776f397_img.jpeg";
			
			$folder_path = SITE_PRODUCT_IMAGES_FOLDER."/p113/";
			...
			$arr_imgname = array();
			$img_data = array();
			$encname = "46ca81ef9f91ee593c733d57d776f397";	
			$imgname = "";
