...
function EditProductOption(option_id)
{
	...
	$.ajax({
			type:'GET',
			url:siteurl+'admin/products/option/option_detail_id/'+option_id,
			dataType:"json",  
			success:function(data)	{ 
...
function UpdateProductOptionValue(value)
{
	if(value != '') {
		...
		$.ajax({
			type:'POST',
			url:siteurl+'admin/products/updateoptionvalue',
			data: value,
			dataType: 'json',
...
{
	$("#product_option_form .productoptval").val("");
...
function AddProductOptionValue(id)
{
	...
	$.ajax({
			type:'POST',
			url:siteurl+'admin/products/addoptionvalue',
			data: ValueString,
			dataType: 'json',
	...
	$( "#dialog-confirm-delete-pod" ).dialog({
		...
		buttons: {
			"Delete": function() {
				...
				$.ajax({
					type:'POST',
					url:siteurl+'admin/products/deleteoptionval',
