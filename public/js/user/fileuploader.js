...
**/
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result.success){
			...
			var ImageDiv = '';
				ImageDiv += '<li id="imagegallery'+result.id+'">';
				ImageDiv += '	<div class="prodimg">';
				...
				ImageDiv += '		</a></div>';
				ImageDiv += '		<div class="clear"></div>';
				ImageDiv += '	</div>';
				ImageDiv += '</li>';
			var image_string = '';
			
			if($("#imagegallery").children().html() == null) {
				image_string = '';
			} else {
				image_string = $("#imagegallery").html();
			}
			
			$("#imagegallery").html(image_string+ImageDiv);
